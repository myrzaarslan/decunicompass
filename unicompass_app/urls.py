...
urlpatterns = [
    ...
    path('api/uni/the/<int:nid>/', views.the_university_detail, name='the_university_detail'),
    path('api/uni/qs/<int:nid>/', views.qs_university_detail, name='qs_university_detail'),
